...
namespace WayfinderServer.Migrations
{
    ...
    [Migration("20211027153028_FloorSwitcher")]
    partial class FloorSwitcher
    {
            ...
            modelBuilder.Entity("WayfinderServer.Entities.FloorSwitcherPoint", b =>
                {
                    ...
                    b.HasOne("WayfinderServer.Entities.Place", null)
                        .WithMany("FloorSwitcherPoints")
                        .HasForeignKey("PlaceId");
