...
namespace WayfinderServer.Migrations
{
    ...
    [Migration("20210328171152_FloorTables")]
    partial class FloorTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WayfinderServer.Entities.Floor", b =>
                {
                    ...
                    b.Property<int?>("FloorPlan2DId")
                        .HasColumnType("int");

                    b.Property<int?>("FloorPlan3DId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FloorPlan2DId");

                    b.HasIndex("FloorPlan3DId");
            ...
            modelBuilder.Entity("WayfinderServer.Entities.Floor", b =>
                {
                    b.HasOne("WayfinderServer.Entities.FloorPlan2D", "FloorPlan2D")
                        .WithMany()
                        .HasForeignKey("FloorPlan2DId");

                    b.HasOne("WayfinderServer.Entities.FloorPlan3D", "FloorPlan3D")
                        .WithMany()
                        .HasForeignKey("FloorPlan3DId");
