...
namespace UnityEngine.XR.ARFoundation.Samples
{
    ...
    public class DynamicLibrary : MonoBehaviour
    {
        ...
        public void CreateTargetImages(byte[] result)
        {
            ...
            ITargetList targetList = new TargetList();
            targetList = targetList.TargetListFromJson(targetsJson);
            ...
            foreach (var target in targetList.Targets)
            {
                ...
                imagedata.texture = textureQR;
                imagedata.name = target.name;
