...
public class PlacesListViewFactory : IPlacesListViewFactory
{
    ...
    public PlacesListViewFactory()
    {
        ...
        var instance = GameObject.Find("PlacesListCanvas").transform.Find("Places Panel").transform.Find("List Panel").transform.Find("List Panel").transform.Find("Scrollable List");
...
public class PlacesListControllerFactory : IPlacesListControllerFactory
{
    ...
    public PlacesListControllerFactory() : this(new PlaceList(), new PlacesList()) { }
}
